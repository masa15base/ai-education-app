...
def generate_character(
    ...
    return {
        ...
        "stage_label_ja": meta.get("stage_label_ja"),
        "next_stage_label_ja": meta.get("next_stage_label_ja"),
        "next_stage_preview_hint_ja": meta.get("next_stage_preview_hint_ja"),
        "hero_stage_label_ja": meta.get("hero_stage_label_ja"),
        "hero_preview_hint_ja": meta.get("hero_preview_hint_ja"),
        "current_preview_hint_ja": meta.get("current_preview_hint_ja"),
